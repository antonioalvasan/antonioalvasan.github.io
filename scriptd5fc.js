...
tryInjectRosettaScript('https://d3cy3u1txmkqs3.cloudfront.net/rosetta/translations2022/new-frontend/files/new-frontend.es_ES.540335970.js', 'https://ecwid-rosetta.s3.amazonaws.com/translations2022/new-frontend/files/new-frontend.es_ES.540335970.js');
})();
(function() {
...
script.src = selectJsVersion('https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-storefront.5f6146356fd1534fa17a7c9c64b4669f.min.js');
document.getElementsByTagName('head')[0].appendChild(script);
}
...
script.src = selectJsVersion('https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-checkout.97e3a367a0aa71f7b1d8ccd8016c5c4e.min.js');
document.getElementsByTagName('head')[0].appendChild(script);
...
EcwidObj.storefrontVersion = "2024-23893-gbfea7c197bbe45";
...
EcwidObj.OnSubscriptionsChanged = new ep;
EcwidObj.signature = "a4f0596334bb2986b9adc11a4a777539-0";
...
window.ec_legacyCssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-896668474&ownerid=87191358' + cssUrlAddition;
var cssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-896668474&ownerid=87191358' + cssUrlAddition;
...
return [
{
namespace: 'beedigital',
cssUrl: null,
jsUrl: 'https://estaticos.paginasamarillas.es/paginasamarillas/images/home/target/ecwid/analytic.js',
asyncJs: true
},
{
namespace: 'prod_beedigital',
cssUrl: null,
jsUrl: 'https://estaticos.paginasamarillas.es/paginasamarillas/images/home/target/ecwid/analytic-prod.js',
asyncJs: true
},
{
namespace: 'recently-viewed-products',
cssUrl: 'https://djqizrxa6f10j.cloudfront.net/apps/thirdparty/recently-viewed-products/files/1.2.0/recently-products.css',
jsUrl: 'https://djqizrxa6f10j.cloudfront.net/apps/thirdparty/recently-viewed-products/files/1.2.2/recently-products.js',
asyncJs: true
},
{
...
const isNavigationStartedFromStorefrontV3App = window.getEcwidV3Object() !== undefined;
if (!isNavigationStartedFromStorefrontV3App) {
...
xInjectJs('https://d3dq8sxcny4hg.cloudfront.net/states.js?version=2024-23893-gbfea7c197bbe45&callback=window.ecwid_states_data.loaded');
...
window.ecwid_script_base="https://d11s7fcxy18ubx.cloudfront.net/node/static/2024/2024-23893-gbfea7c197bbe45/ru.cdev.xnext.frontend.LegacyFrontend/";
window.ecwid_static_base="https://d11s7fcxy18ubx.cloudfront.net/node/static/2024/2024-23893-gbfea7c197bbe45/"
window.ecwid_url="https://app.mitienda.beedigital.es/";
...
window.xnext_ownerId=87191358;
EcwidObj.publicToken = "public_w9eJXPSjr8HcnPfc9MayCp3YQjLpVuw3",
EcwidObj.demo=false;
EcwidObj.cssUrl="https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-896668474&ownerid=87191358";
EcwidObj.acceptLanguage=["es"];
EcwidObj.appDomain="https://app.mitienda.beedigital.es/";
EcwidObj.startup_flags = {
amazonImageDomain: window.amazon_image_domain,
googleMapsKey: "AIzaSyCNCmAGyN4bJYu5qeLgbASzZafm-M5TA_o"
};
EcwidObj.customerLanguage='es';
(function() {
...
window.ecwid_initial_data.data.isWhiteLabel = data.isWhiteLabel;
window.ecwid_initial_data.data.storeConfig = data.storeConfig;
window.ecwid_initial_data.data.categories = data.categories;
}
var ecDataJsBaseUrl = "https://app.mitienda.beedigital.es/data.js?ownerid=87191358";
ecDataJsBaseUrl += "&lang=es";
ecDataJsBaseUrl += "&token=5daf39ed379bbbe80c7fb7ea5d1d433f875bfd05";
...
var tokenMap = {"recently-viewed-products":"public_f2wJUumwsDMYwSCzmVhv5sbLYDdCrZcJ","beedigital":"public_gXdDtXg5AEWjg1BpZnMPVVAknbsxCPRB","ecwid-storefront":"public_w9eJXPSjr8HcnPfc9MayCp3YQjLpVuw3","prod_beedigital":"public_tXYiM3CUBb8TSPQk2JCdjZ7KcTELQb66"};
...
EcwidObj.getAppPublicConfig = function(namespace) {
	var publicData = {"beedigital":"{\"digitalKit\":true}","prod_beedigital":"{}","ecwid-customers-app":"{}","ecwid-vuega-app":"{}","ecwid-fbshops":"{}","recently-viewed-products":"{\"maxShown\":\"5\",\"place\":\"custom\",\"container\":\".ecwid-productBrowser\"}","storefront-label-editor":"{}","ecwid-storefront":"{}","ecwid-degenerator-app":"{}","ecwid-apigate-app":"{}","starter-site":"{}","ecwid-cpsettings-app":"{}","ecwid-domenator-app":"{}"};
